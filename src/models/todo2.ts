...
const readTodosFromFile = (fname: string = "todos.json"): todo[] => {
...
const filterTodos = <Key extends keyof todo>(items: todo[], key: Key, value: string | number | boolean, strict: boolean = false): todo[] => {
...
const newTodo = (item: todo): number => {
